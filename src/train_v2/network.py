...
class DualDiscriminator(torch.nn.Module):
    ...
    def __init__(self, input_channels = 3, force_depth=False, pool_type="max", edge_weight_type=10, wei_param=2):
        super().__init__()
        self.force_depth = force_depth
        ...
        self.fc_v2 = torch.nn.Linear(3, 1) if self.force_depth else torch.nn.Linear(3, 3)
        
        # facet graph
        self.discriminator_f = DiscriminatorModule(input_channels, 32, pool_type, 2, edge_weight_type, wei_param) #outchanneels = 32
